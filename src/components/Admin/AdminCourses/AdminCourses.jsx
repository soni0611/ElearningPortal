...
const AdminCourses = () => {
  // const courses=[{
  //   _id:"fvsdcscdcs",title:"React Course",category:"web development",
  //   poster:{
  //     url:'https://cdn.pixabay.com/photo/2023/03/17/16/41/traffic-7859033_960_720.jpg'
  //   },
  //   createdBy:"shivam",
  //   views:123,
  //   numOfVideos:12
  // }]
  // const lectures=[{
  //   _id:"fvsdcscdcs",name:"shivam",role:"admin",
  //   subscription:{
  //     status:"active"
  //   },
  //   email:"shivam.soni@gmail.com"
  // }]
